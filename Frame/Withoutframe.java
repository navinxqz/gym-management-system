...
public class Withoutframe extends JFrame implements ActionListener{
...
public Withoutframe(String name,String password){
	...
	img = new ImageIcon("Photo/Without.png");//Background image
