...
public class yesEquipWorkout extends JFrame implements ActionListener, MouseListener
{
    ...
    public yesEquipWorkout(String name,String password)
    {
        ...
        backgroundIcon = new ImageIcon("Photo/yesEquip.png");
